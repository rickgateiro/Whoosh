# Version: 5.0
# Date: 2024-03-05
# Changes: Added PDF viewer with text highlighting functionality
...
class PDFProcessorGUI:
    ...
    def setup_search_tab(self):
        ...
        self.json_listbox = ttk.Treeview(files_frame, selectmode="browse", show="tree", height=10)
        self.json_listbox.pack(fill=X, padx=5, pady=5)
        
        # TXT Files List
        ttk.Label(files_frame, text="Arquivos TXT:").pack(anchor=W, padx=5, pady=2)
        self.txt_listbox = ttk.Treeview(files_frame, selectmode="browse", show="tree", height=10)
    ...
    def search_documents(self):
        ...
        filename = self.json_listbox.item(selected_json[0])['text']
